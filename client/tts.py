# -*- coding: utf-8-*-
"""
A Speaker handles audio output from Assistant to the user
...
class EspeakTTS(AbstractTTSEngine):
    """
    Uses the eSpeak speech synthesizer included in the Assistant disk image
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Assistant TTS module')
